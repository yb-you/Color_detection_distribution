...
void GPIO_Configuration(void)
{
    ...
    */
    ...
    GPIO_InitStructure_PWM.GPIO_Pin = GPIO_Pin_6|GPIO_Pin_7;	// PB6, PB7 -> motor PWM
 ...
 /*   GPIO_InitStructure_PWM.GPIO_Pin = GPIO_Pin_10|GPIO_Pin_11|GPIO_Pin_12|GPIO_Pin_13;
