...
*/
    ...
    TIM_TimeBaseStructure_PWM.TIM_Period = 19999;     // 72Mhz 입력에서 주기 720으로 나누면 1,000Hz가 된다.
    TIM_TimeBaseStructure_PWM.TIM_Prescaler = 72;   //   여기서 Prescaler가 100이면 10Hz가 된다.
